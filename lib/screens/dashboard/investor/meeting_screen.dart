...
class InvestorMeetingScreen extends StatefulWidget {
  const InvestorMeetingScreen({super.key});

  @override
  State<InvestorMeetingScreen> createState() => _InvestorMeetingScreenState();
}

class _InvestorMeetingScreenState extends State<InvestorMeetingScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: StreamBuilder<DocumentSnapshot>(
        stream: _firestore.collection('investors').doc(_userId).snapshots(),
